...
/* harmony import */ var _renameRecentPosts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./renameRecentPosts */ "./src/renameRecentPosts.js");
/* harmony import */ var _blogSearch__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./blogSearch */ "./src/blogSearch.js");
 // import GoogleMap from "./googleMap";


var renameRecentPostsAndstyleTitleToBeGrey = new _renameRecentPosts__WEBPACK_IMPORTED_MODULE_1__["default"]();

var blogSearch = new _blogSearch__WEBPACK_IMPORTED_MODULE_2__["default"](); // let googleMap = new GoogleMap();
...
var BlogSearch = /*#__PURE__*/function () {
  function BlogSearch() {
    ...
    this.overlay = document.querySelector(".Blog__NavOverlay"); // console.log(
  ...
  _createClass(BlogSearch, [{
    ...
    value: function events() {
      ...
      //     console.log("lämnar");
      // };
      this.searchButton.onmouseenter = function () {
        if (!_this.searchButton.classList.contains("active")) {
          _this.searchButton.classList.remove("hoverState--hidden");

          _this.searchButton.classList.add("hoverState");
        }
      };

      this.searchButton.onmouseleave = function () {
        if (!_this.searchButton.classList.contains("active")) {
          _this.searchButton.classList.remove("hoverState");

          _this.searchButton.classList.add("hoverState--hidden");
        }
      };
      ...
      console.log("🚀 ~ file: blogSearch.js ~ line 22 ~ BlogSearch ~ events ~ this.searchButton", this.searchButton);
      this.testKlick.addEventListener("click", function () {
        return _this.slide();
      });
    } //Handlers
    ...
    value: function openSearch() {
      ...
      this.searchButton.classList.toggle("active"); // this.searchButton.classList.toggle("active");
...
/* harmony default export */ __webpack_exports__["default"] = (BlogSearch);
