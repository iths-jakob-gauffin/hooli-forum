	 ...
	 <h1 id="wpforo-title">
        ...
        <div class="wpforo-feed">
            ...
            <select onchange="window.location.assign(this.value)">
                ...
                <option value="<?php echo esc_url(wpforo_home_url(wpforo_get_template_slug('recent') . '?view=unread' )) ?>" <?php wpfo_check($view, 'unread', 'selected') ?>>
                    <?php wpforo_phrase('Unread Posts') ?>
                </option>
                <option value="<?php echo esc_url(wpforo_home_url(wpforo_get_template_slug('recent') . '?view=no-replies' )) ?>" <?php wpfo_check($view, 'no-replies', 'selected') ?>>
                    <?php wpforo_phrase('Not Replied Topics') ?>
                </option>
                <option value="<?php echo esc_url(wpforo_home_url(wpforo_get_template_slug('recent') . '?view=solved' )) ?>" <?php wpfo_check($view, 'solved', 'selected') ?>>
                    <?php wpforo_phrase('Solved Topics') ?>
                </option>
                <option value="<?php echo esc_url(wpforo_home_url(wpforo_get_template_slug('recent') . '?view=unsolved' )) ?>" <?php wpfo_check($view, 'unsolved', 'selected') ?>>
                    <?php wpforo_phrase('Unsolved Topics') ?>
                </option>
                <option value="<?php echo esc_url(wpforo_home_url(wpforo_get_template_slug('recent') . '?view=closed' )) ?>" <?php wpfo_check($view, 'closed', 'selected') ?>>
                    <?php wpforo_phrase('Closed Topics') ?>
                </option>
                <option value="<?php echo esc_url(wpforo_home_url(wpforo_get_template_slug('recent') . '?view=opened' )) ?>" <?php wpfo_check($view, 'opened', 'selected') ?>>
                    <?php wpforo_phrase('Opened Topics') ?>
                </option>
                <option value="<?php echo esc_url(wpforo_home_url(wpforo_get_template_slug('recent') . '?view=sticky' )) ?>" <?php wpfo_check($view, 'sticky', 'selected') ?>>
                    <?php wpforo_phrase('Sticky Topics') ?>
                </option>
                <?php if( wpforo_current_user_is('admin') || wpforo_current_user_is('moderator') ): ?>
                    <option value="<?php echo esc_url(wpforo_home_url(wpforo_get_template_slug('recent') . '?view=private' )) ?>" <?php wpfo_check($view, 'private', 'selected') ?>>
                        <?php wpforo_phrase('Private Topics') ?>
                    </option>
                    <option value="<?php echo esc_url(wpforo_home_url(wpforo_get_template_slug('recent') . '?view=unapproved' )) ?>" <?php wpfo_check($view, 'unapproved', 'selected') ?>>
              ...
              <?php foreach($topics as $topic) : extract($topic, EXTR_OVERWRITE); ?>
                  ...
                  <tr class="wpf-ttr <?php wpforo_unread($topic['topicid'], 'topic'); ?>">
                    ...
                    <td class="wpf-spost-title">
                        <?php wpforo_topic_icon($topic); ?> <a href="<?php wpforo_unread_url( $topic['topicid'], $topic_url ) ?>" class="wpf-spost-title-link" title="<?php wpforo_phrase('View entire topic') ?>"><?php echo esc_html($title) ?></a>&nbsp;<?php wpforo_unread_button($topic['topicid'], $topic_url); ?> <?php wpforo_viewing( $topic ); ?>
